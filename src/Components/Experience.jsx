  ...
  return (
    <div className="container mx-auto rounded-md shadow-md">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-200">University of Windsor - Windsor, Ontario, Canada</p>
        <p className="text-sm text-gray-200">Jan 2023 - Present · 1 yr 2 mos</p>
      </div>
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-200">TOPS Technologies Pvt. Ltd - Ahmedabad</p>
        <p className="text-sm text-gray-200">Nov 2021 - Nov 2022 · 1 yr 1 mo</p>
        <p className="text-sm text-gray-200">Technology Used: ReactJS, NodeJS, Linux, AWS, HTML, CSS, Agile Methodologies</p>
      ...
      <div>
        ...
        <div className="flex flex-wrap">
          {[
            'JavaScript', 'NodeJS', 'ReactJS', 'Python', 'HTML', 'CSS', 'REST API',
            'MySQL', 'MongoDB',
